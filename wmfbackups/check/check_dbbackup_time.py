...
MYSQL_CONFIG_FILE - Path of the ini config file with the mysql connection details
                    on a [client] section

Usage example:
  $ sudo check-dbbackups-time
"""
...
def main():
    ...
    mysql_config_file = os.environ.get('MYSQL_CONFIG_FILE', '/etc/wmfbackups/backups_check.ini')
